...
### chromato-overdue-phase.md (Superseded)
**Status**: Superseded by chromato-pomodoro-phases.md as of 2026-04-05

This document is retained for reference but should not be treated as the primary explanation for the OVERDUE phase. All OVERDUE concepts are now integrated into the comprehensive five-phase explanation in `chromato-pomodoro-phases.md`.

For new readers, start with `chromato-pomodoro-phases.md`. For reviewers maintaining prior context, this document remains accessible but is no longer the authoritative reference.
